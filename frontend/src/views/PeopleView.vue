          ...
          <div class="matches-list">
            ...
            >
              <div class="match-score-container">
                <div class="circle-container">
                  <svg viewBox="0 0 40 40" class="score-circle">
                    ...
                    />
                    <!-- Ta bort transform: rotate(-90deg) från .score-circle och lägg det på bara cirklarna -->
                    <g>
              ...
              <div class="match-header">
                ...
                <span class="match-company">({{ top.exhibitor.company }})</span>
              </div>
...
.match-card {
  ...
  padding: 1.5rem 1rem 1rem 1rem; /* Extra top-padding för cirkeln */
  display: flex;
  flex-direction: column;
  ...
  overflow: visible; /* Viktigt för att cirkeln ska synas utanför */
}
...
.match-score-container {
  position: absolute;
  top: -24px;   /* Flytta utanför kortet */
  right: -24px; /* Flytta utanför kortet */
  z-index: 2;
  background: #e3f0fd;
  border-radius: 50%;
...
.score-circle {
  width: 44px;
  height: 44px;
  /* Ta bort transform: rotate(-90deg); */
}
.circle-bg,
.circle-fg {
